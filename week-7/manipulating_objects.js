...
// I worked on this challenge by myself for   hours.
...
I had trouble getting the children test to pass.  I wasnt adding the name property in the correct location. I thought I was adding a name property to childen and assigning it mulitple values like an array of the names.
How difficult was it to add and delete properties outside of the object itself?
The adding of properties was easy, it like how you create one inside an object but just assigning it a new value. I had to look up how to delete a property. 
What did you learn about manipulating objects in this challenge?
I learned you can create a new object by using empty curly braces instead of new Object(). I learned about nested objects. Like I statement above I thought it was all together instead of a new object with in the terah object.
And if I am not explaining this correctly please correct me. 
